export const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <p>Hello,</p>
              <p> Please confirm verify your email address by entering the code below:</p>
              <span class="verification-code">{verificationCode}</span>
              <p>If you did not make this move, no further action is required. If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Your Ushop. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
