      ...
      <div className="container w-full mx-auto flex justify-between items-center text-black">
        ...
        <div className="">
          <input
            type="text"
            placeholder="Search..."
            className={`w-[120px] md:w-[250px]  border-2 border-transparent focus:border-blue-600 focus:outline-none p-2 rounded-l-md text-black placeholder-black ${isOpaque?'bg-white':'bg-transparent'}`} // Adjust width and padding for medium size
            value = {searchVal}
